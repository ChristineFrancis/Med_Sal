...
class Themes{
  ...
  static ThemeData CustomDark=ThemeData.dark().copyWith(
    ...
    appBarTheme: AppBarTheme(
      ...
      colorScheme: ColorScheme(brightness: Brightness.dark, primary: AppColor.primaryLightColor, onPrimary:AppColor.darkModeColor , secondary: AppColor.primaryDarkColor, onSecondary: AppColor.darkModeColor, error: AppColor.darkModeColor, onError: AppColor.darkModeColor, surface: AppColor.primaryLightColor, onSurface: AppColor.primaryLightColor,primaryContainer:AppColor.darkModeColor , onSecondaryContainer:AppColor.darkModeColor),
...
static ThemeData CustomLight=ThemeData.light().copyWith(
    textTheme: TextTheme(displayLarge: TextStyle(fontSize: 20, fontWeight: FontWeight.w400, color: AppColor.blackColor),
    ...
    colorScheme: ColorScheme(brightness: Brightness.light, primary: AppColor.primaryLightColor, onPrimary:AppColor.searchColor , secondary: AppColor.primaryDarkColor, onSecondary: AppColor.whiteColor, error: AppColor.searchColor, onError: AppColor.searchColor, surface:Colors.black, onSurface: Colors.black,primaryContainer:AppColor.primaryLightColor, onSecondaryContainer:AppColor.whiteColor    ),
    );
